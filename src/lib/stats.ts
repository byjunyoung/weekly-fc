 ...
 *  `stamina` 는 이름만 **피지컬**이다(2026-09-25 "체력이 아니라 피지컬") — 열 이름·기록의 field 값은 그대로 둔다. */
export const STAT_KO: Record<StatKey, string> = { pace: '페이스', dribble: '드리블', pass: '패스', shoot: '슈팅', defend: '수비', stamina: '피지컬' };
